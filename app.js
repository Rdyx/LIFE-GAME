...
$('#start').click(function move() {
    ...
    for (var w = 0; w < tableau.length; w++){
        ...
        if (tableau[w] < 10) {
            ...
            $('#num' + caseNum).html($('#num' + tableau[w]).html());
            $('#num' + tableau[w]).html('');
        }
    }
});
...
function topCheck(arg1,arg2){
    if (arg1 < 10) {
        $('#num0' + arg1).html($('#num0' + tableau[arg2]).html());
        $('#num0' + tableau[arg2]).html('');
    } else {
        $('#num' + arg1).html($('#num0' + tableau[arg2]).html());
        $('#num0' + tableau[arg2]).html('');
    }
}
